...
def loop_drive():
    count = 1 # number of loop iterations
    ...
    while(1):
        ...
        pdTargets = np.array([100, 100]) # Input requested PhiDots (radians/s)
        ...
        time.sleep(.05) # this time controls the frequency of the controller
